      ...
      <ul class="navbar-nav bg-gradient-secondary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
          ...
          <div id="master" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <a class="collapse-item" href="<?= base_url('admin/data_baut') ?>">Data Baut</a>
              <a class="collapse-item" href="<?= base_url('admin/data_barang_masuk') ?>">Barang Masuk</a>
            </div>
          </div>
        </li>
        <li class="nav-item">
          ...
          <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="<?= base_url('order_barang/order_selesai') ?>">Riwayat Order Selesai</a>
              <a class="collapse-item" href="<?= base_url('order_barang/order_ditolak') ?>">Riwayat Order Dibatalkan</a>
            </div>
          </div>
        </li>
        ...
        <li class="nav-item">
          ...
          <div id="laporan" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <a class="collapse-item" href="<?= base_url('admin/surat_masuk') ?>">Laporan Barang Masuk</a>
            </div>
          </div>
        </li>
        <!-- Divider -->
